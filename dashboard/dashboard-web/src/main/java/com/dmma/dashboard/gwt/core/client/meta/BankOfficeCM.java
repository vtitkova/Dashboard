...
public class BankOfficeCM implements IGwtEntityCM{
	...
	public BankOfficeCM() {
		...
		externalIdColumn = new GwtColumnMetadata(DashboardMessages.MSG.externalId(),  Long.class ,60);
	...
	public GwtColumnMetadata[] getColumnMeta(){
		return new GwtColumnMetadata[]{ idColumn, externalIdColumn, nameColumn, addressColumn,
