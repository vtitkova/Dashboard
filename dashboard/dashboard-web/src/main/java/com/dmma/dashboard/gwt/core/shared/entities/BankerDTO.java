...
public class BankerDTO implements GwtEntityInterface, ContactInfoBig, ContactInfoSmall{
	private Integer id;
	...
	private BankOfficeDTO bankOffice;
	
	
	public BankerDTO() {
	}

	public BankerDTO(Integer id) {
		setId(id);
	}
	...
	public void setBankOffice(BankOfficeDTO bankOffice) {
		this.bankOffice = bankOffice;
	}

	public BankOfficeDTO getBankOffice() {
		return bankOffice;
	}
	...
	public void setValueAt(int index, Object value) {
		...
		case 2: externalId= (Long)    value; return;
		...
		case 9: bankOffice = (BankOfficeDTO) value; return;
		}
	}
