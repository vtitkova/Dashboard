...
public class AgentView  implements java.io.Serializable {
    ...
    public AgentView(
           ...
           this.nShowID = nShowID;
           this.bCancel = bCancel;
    }


    /**
     * Gets the sIdentityKey value for this AgentView.
     * 
     * @return sIdentityKey
     */
    ...
    /**
     * Sets the sIdentityKey value for this AgentView.
     * 
     * @param sIdentityKey
     */
    ...
    /**
     * Gets the sAccessKey value for this AgentView.
     * 
     * @return sAccessKey
     */
    ...
    /**
     * Sets the sAccessKey value for this AgentView.
     * 
     * @param sAccessKey
     */
    ...
    /**
     * Gets the sUserKey value for this AgentView.
     * 
     * @return sUserKey
     */
    ...
    /**
     * Sets the sUserKey value for this AgentView.
     * 
     * @param sUserKey
     */
    ...
    /**
     * Gets the nShowID value for this AgentView.
     * 
     * @return nShowID
     */
    public int getNShowID() {
        return nShowID;
    }


    /**
     * Sets the nShowID value for this AgentView.
     * 
     * @param nShowID
     */
    public void setNShowID(int nShowID) {
        this.nShowID = nShowID;
    }


    /**
     * Gets the bCancel value for this AgentView.
     * 
     * @return bCancel
     */
    ...
    /**
     * Sets the bCancel value for this AgentView.
     * 
     * @param bCancel
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AgentView)) return false;
        ...
        _equals = true && 
            ...
            this.nShowID == other.getNShowID() &&
            this.bCancel == other.isBCancel();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += getNShowID();
        _hashCode += (isBCancel() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AgentView.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://emprof.no/", ">AgentView"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("NShowID");
        elemField.setXmlName(new javax.xml.namespace.QName("http://emprof.no/", "nShowID"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("BCancel");
        elemField.setXmlName(new javax.xml.namespace.QName("http://emprof.no/", "bCancel"));
